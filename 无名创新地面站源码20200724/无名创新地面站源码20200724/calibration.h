...
extern int16_t rc_min[8];
extern int16_t rc_max[8];
...
private slots:
    ...
    void on_rc_cal_start_clicked();

    void on_rc_cal_save_clicked();

    void on_bt1_mag_cal_clicked();

    void on_bt2_mag_cal_clicked();

    void on_bt3_mag_cal_clicked();
